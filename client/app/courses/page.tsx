                ...
                <>
                    ...
                    <div className='w-[95%] 800px:w-[85%] m-auto  min-h-[70vh]'>
                        ...
                        <div className='w-full flex items-center flex-wrap'>
                            ...
                            <div className={`h-[35px] ${category === 'All' ? "bg-[crimson]" : "bg-[#5050cb]"} m-3 px-3 rounded-[30px] flex items-center justify-center font-Poppins cursor-pointer text-white`} onClick={() => setCategory('All')}>
                                All
                            </div>
                            ...
                            {categories && categories.map((item: any, index: number) => (
                                ...
                                <div key={index} >
                                    ...
                                    <div className={`h-[35px] ${category === item.title ? "bg-[crimson]" : "bg-[#5050cb]"} m-3 px-3 rounded-[30px] flex items-center justify-center font-Poppins cursor-pointer text-white`} onClick={() => setCategory(item.title)}>
                                        {item.title}
                                    </div>
                        ...
                        {courses && courses.length === 0 && (
                            ...
                            <p className={`${styles.label} justify-center min-h-[50vh] flex items-center text-black dark:text-white`}>
