...
const SidebarProfile: FC<Props> = ({ user, active, avatar, setActive, logoutHandler }) => {
    ...
    return (
        ...
        <div className='w-full'>
            ...
            <div className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 2 ? 'dark:bg-slate-800 bg-slate-100' : 'bg-transparent'}`} onClick={() => setActive(2)}>
            ...
            <div className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 3 ? 'dark:bg-slate-800 bg-slate-100' : 'bg-transparent'}`} onClick={() => setActive(3)}>
            ...
            <div className={`w-full flex items-center px-3 py-4 cursor-pointer ${active === 4 ? 'dark:bg-slate-800 bg-slate-100' : 'bg-transparent'}`} onClick={() => logoutHandler()}>
