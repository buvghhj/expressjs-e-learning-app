...
import avatarIcon from '../../../public/img/avatar.jpg'
        ...
        <>
            ...
            <div className='w-full flex justify-center'>
                ...
                <div className='relative'>
                    ...
                    <Image src={user.avatar || avatar ? user.avatar.url || avatar : avatarIcon} alt='' width={120} height={120} className='w-[120px] h-[120px] object-cover cursor-pointer border-[3px] border-[#37a39a] rounded-full' />
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='800px:w-[50%] m-auto block pb-4'>
                        ...
                        <div className='w-[100%] pt-2'>
                            ...
                            <input type="text" className={`${styles.input} !w-[95%] mb-1 800px:mb-0 cursor-not-allowed`} required value={user?.email} onChange={(e) => setName(e.target.value)} readOnly />

                        </div>

                        <input type="submit" className={`w-[95%]  h-[40px] border border-[#37a39a] text-center dark:text-[#fff] text-black rounded-[3px] mt-8 cursor-pointer`} required value='Update' />
