            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='w-full mt-5 relative mb-1'>
                    ...
                    {!show
                        ?
                        (
                            <AiOutlineEyeInvisible className='absolute bottom-3 right-2 z-1 dark:text-white text-black cursor-pointer' size={20} onClick={() => setShow(true)} />
                        )
                        :
                        (
                            <AiOutlineEye className='absolute bottom-3 right-2 z-1 dark:text-white text-black cursor-pointer' size={20} onClick={() => setShow(false)} />
                        )
                    }
                ...
                <div className='flex items-center justify-center my-3'>
                    ...
                    <AiFillGithub size={30} className='cursor-pointer ml-2 dark:text-white' onClick={() => signIn("github")} />
