...
const CourseDetail: FC<Props> = ({ data, clientSecret, stripePromise, setRoute, setOpen: openAuthModal }) => {
            ...
            <div className='w-[90%] 800px:w-[90%] m-auto py-5'>
                ...
                <div className='w-full flex flex-col-reverse 800px:flex-row'>
                    ...
                    <div className='w-full 800px:w-[65%] 800px:pr-5'>
                        ...
                        <h1 className='text-[22px] font-Poppins font-[600] text-black dark:text-white'>
                            {data.name}
                        </h1>
                                ...
                                {(data?.reviews && [...data.reviews].reverse()).map((item: any, index: number) => (
                                    ...
                                    <div className='w-full pb-4' key={index}>
                                        ...
                                        {item.commentReplies.map((i: any, index: number) => (
                                            ...
                                            <div className='w-full flex 800px:!ml-14 ml-14 my-5 text-black dark:text-white' key={index}>
