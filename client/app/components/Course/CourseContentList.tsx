        ...
        <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[-30px]  sticky top-24 left-0 z-30'}`}>
            {videoSections.map((section: string, sectionIndex: number) => {
                ...
                return (
                    ...
                    <div className={`${!props.isDemo && 'border-b dark:border-[#ffffff8e] pb-2'}`} key={section}>
                        ...
                        {isSectionVisible && (
                            ...
                            <div className='w-full'>
                                ...
                                {sectionVideos.map((item: any, index: number) => {
                                    ...
                                    return (
                                        <div
                                            className={`w-full ${videoIndex === props.activeVideo ? "bg-slate-800" : ""} rounded-md cursor-pointer transition-all p-2 `}
                                            key={item._id}
