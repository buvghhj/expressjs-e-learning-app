...
const EditCategories = (props: Props) => {
    ...
    const [editLayout, { isSuccess: successCategory, error }] = useEditLayoutMutation()
            ...
            {isLoading ? (<Loader />) : (
                ...
                <div className='mt-[120px] text-center'>
                    ...
                    <div className='w-full flex justify-center'>
                        ...
                        <IoMdAddCircleOutline className='dark:text-white text-black text-[25px] cursor-pointer' onClick={newCategoriesHandle} />
...
${areCategoriesUnchanged(data?.layout.categories, categories) ||
                        ...
                        onClick={areCategoriesUnchanged(data?.layout.categories, categories) || isAnyCategoryEmpty(categories) ? () => null : editCategoriesHandler}
                    >
                        Save
                    </div>
