...
const CourseContent: FC<Props> = ({ active, setActive, courseContentData, setCourseContentData, handleSubmit: handleCourseSubmit }) => {
    ...
    const newContentHandler = (item: any) => {
        ...
        if (item.title === "" || item.description === "" || item.videoUrl === "" || item.videoLength === "" || item.links[0].title === "" || item.links[0].url === "") {
    ...
    return (
        ...
        <div className='w-[80%] m-auto mt-24 p-3'>
                ...
                {courseContentData?.map((item: any, index: number) => {
                    ...
                    return (
                        <>
                            ...
                            <div className={`w-full bg-[#cdc8c817] p-4 ${showSectionInput ? "mt-10" : "mb-0"}  rounded-md`}>
            ...
            <div className='w-full flex  items-center justify-between'>
                ...
                <div className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-white rounded mt-8 cursor-pointer' onClick={() => nextPreviewHandler()}>
                    Next
                </div>
